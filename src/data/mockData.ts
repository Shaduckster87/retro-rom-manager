...
export const MOCK_ROMS: RomFile[] = [
  { id: '1', title: 'Super Mario Bros.', filename: 'Super_Mario_Bros.nes', console: 'NES', file_extension: '.nes', file_size: 40976, upload_date: '2024-03-15', hash: MOCK_HASHES[0], status: 'sorted', storage_path: '/roms/NES/Super_Mario_Bros.nes' },
  { id: '2', title: 'The Legend of Zelda', filename: 'Legend_of_Zelda.nes', console: 'NES', file_extension: '.nes', file_size: 131088, upload_date: '2024-03-15', hash: MOCK_HASHES[1], status: 'sorted', storage_path: '/roms/NES/Legend_of_Zelda.nes' },
  { id: '3', title: 'Sonic the Hedgehog', filename: 'Sonic_the_Hedgehog.md', console: 'Genesis', file_extension: '.md', file_size: 524288, upload_date: '2024-03-14', hash: MOCK_HASHES[2], status: 'sorted', storage_path: '/roms/Genesis/Sonic_the_Hedgehog.md' },
  { id: '4', title: 'Super Mario World', filename: 'Super_Mario_World.sfc', console: 'SNES', file_extension: '.sfc', file_size: 524288, upload_date: '2024-03-14', hash: MOCK_HASHES[3], status: 'sorted', storage_path: '/roms/SNES/Super_Mario_World.sfc' },
  { id: '5', title: 'Pokémon Red', filename: 'Pokemon_Red.gb', console: 'Game Boy', file_extension: '.gb', file_size: 1048576, upload_date: '2024-03-13', hash: MOCK_HASHES[4], status: 'sorted', storage_path: '/roms/GB/Pokemon_Red.gb' },
  { id: '6', title: 'Super Mario Bros. (Copy)', filename: 'Super_Mario_Bros_v2.nes', console: 'NES', file_extension: '.nes', file_size: 40976, upload_date: '2024-03-16', hash: MOCK_HASHES[0], status: 'duplicate', storage_path: '/duplicates/Super_Mario_Bros_v2.nes', duplicate_group_id: 'dup-1' },
  { id: '7', title: 'Super Mario Bros.', filename: 'SMB1.nes', console: 'NES', file_extension: '.nes', file_size: 40976, upload_date: '2024-03-17', hash: MOCK_HASHES[0], status: 'duplicate', storage_path: '/duplicates/SMB1.nes', duplicate_group_id: 'dup-1' },
  { id: '8', title: 'Super Mario Bros. (Original)', filename: 'Super_Mario_Bros.nes', console: 'NES', file_extension: '.nes', file_size: 40976, upload_date: '2024-03-15', hash: MOCK_HASHES[0], status: 'duplicate', storage_path: '/roms/NES/Super_Mario_Bros.nes', duplicate_group_id: 'dup-1' },
  { id: '9', title: 'Sonic (Copy)', filename: 'Sonic1.md', console: 'Genesis', file_extension: '.md', file_size: 524290, upload_date: '2024-03-18', hash: MOCK_HASHES[2], status: 'duplicate', storage_path: '/duplicates/Sonic1.md', duplicate_group_id: 'dup-2' },
  { id: '10', title: 'Sonic the Hedgehog', filename: 'Sonic_the_Hedgehog.md', console: 'Genesis', file_extension: '.md', file_size: 524288, upload_date: '2024-03-14', hash: MOCK_HASHES[2], status: 'duplicate', storage_path: '/roms/Genesis/Sonic_the_Hedgehog.md', duplicate_group_id: 'dup-2' },
  ...
  { id: '14', title: 'Metroid', filename: 'Metroid.nes', console: 'NES', file_extension: '.nes', file_size: 131088, upload_date: '2024-03-12', hash: 'c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3', status: 'sorted', storage_path: '/roms/NES/Metroid.nes' },
  { id: '15', title: 'Final Fantasy VI', filename: 'Final_Fantasy_VI.sfc', console: 'SNES', file_extension: '.sfc', file_size: 3145728, upload_date: '2024-03-11', hash: 'd4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4', status: 'sorted', storage_path: '/roms/SNES/Final_Fantasy_VI.sfc' },
  { id: '16', title: 'Street Fighter II', filename: 'sf2.zip', console: 'MAME', file_extension: '.zip', file_size: 6291456, upload_date: '2024-03-10', hash: 'e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5', status: 'sorted', storage_path: '/roms/MAME/sf2.zip' },
  { id: '17', title: 'Castlevania', filename: 'Castlevania.nes', console: 'NES', file_extension: '.nes', file_size: 131088, upload_date: '2024-03-09', hash: 'f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6', status: 'sorted', storage_path: '/roms/NES/Castlevania.nes' },
  { id: '18', title: 'Pokémon Blue', filename: 'Pokemon_Blue.gb', console: 'Game Boy', file_extension: '.gb', file_size: 1048576, upload_date: '2024-03-08', hash: 'a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7', status: 'sorted', storage_path: '/roms/GB/Pokemon_Blue.gb' },
];
